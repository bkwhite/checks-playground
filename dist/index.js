module.exports = (() => {
    var __webpack_modules__ = {
        822: function (e, t, r) {
                ...
                function (e, t, r, s) {
                    ...
                    return new (r || (r = Promise))(function (r, o) {
                        ...
                        function step(e) {
                            e.done
                                ? r(e.value)
                                : adopt(e.value).then(fulfilled, rejected)
                        }
            ...
            function run() {
                return i(this, void 0, void 0, function* () {
                    const e = a.getInput('GITHUB_TOKEN')
                    const t = c.getOctokit(e)
                    const { context: r } = c
                    const { repository: s } = r.payload
                    yield t.checks.create({
                        owner:
                            s === null || s === void 0 ? void 0 : s.owner.login,
                        repo: s === null || s === void 0 ? void 0 : s.full_name,
                        name: 'Cypress Check',
                        head_sha: r.sha,
        ...
        186: function (e, t, r) {
            ...
            function exportVariable(e, t) {
                ...
                if (s) {
                    ...
                    const s = `${e}<<${t}${c.EOL}${r}${c.EOL}${t}`
                    i.issueCommand('ENV', s)
                } else {
                    n.issueCommand('set-env', { name: e }, r)
                }
            }
                ...
                async request(e, t, r, s) {
                    ...
                    while (c < i) {
                        ...
                        if (
                            u &&
                            u.message &&
                            u.message.statusCode === a.Unauthorized
                        ) {
                            let e
                        ...
                        while (
                            p.indexOf(u.message.statusCode) != -1 &&
            ...
            class Octokit {
                constructor(e = {}) {
                    ...
                    r.headers['user-agent'] = [
                        e.userAgent,
                        `octokit-core.js/${c} ${s.getUserAgent()}`,
                    ]
                        .filter(Boolean)
                        .join(' ')
                    if (e.baseUrl) {
                    ...
                    if (!e.authStrategy) {
                        if (!e.auth) {
                            ...
                            const r = a.createTokenAuth(e.auth)
        ...
        668: (e, t, r) => {
            ...
            const c = withDefaults(s.request, {
                headers: {
            ...
            function endpointsToMethods(e, t) {
                ...
                for (const [s, o] of Object.entries(t)) {
                    for (const [t, n] of Object.entries(o)) {
                        ...
                        const l = r[s]
                        if (a) {
                            l[t] = decorate(e, s, t, p, a)
                            continue
                        }
                        l[t] = e.request.defaults(p)
                    }
                }
                return r
            }
        ...
        234: (e, t, r) => {
                ...
                return o(
                    ...
                    .then((o) => {
                        ...
                        if (e.method === 'HEAD') {
                            ...
                            throw new a.RequestError(o.statusText, r, {
                                headers: t,
                                request: e,
                            })
                        }
                        ...
                        if (r >= 400) {
                            return o.text().then((s) => {
                                const o = new a.RequestError(s, r, {
                                    headers: t,
                                    request: e,
                                })
                                try {
            ...
            const u = withDefaults(s.endpoint, {
                headers: {
                    'user-agent': `octokit-request.js/${c} ${o.getUserAgent()}`,
                },
            })
            t.request = u
        },
        682: (e, t, r) => {
            ...
            function bindApi(e, t, r) {
                var s = a(n, null).apply(null, r ? [t, r] : [t])
                e.api = { remove: s }
                e.remove = s
            ...
            function fetch(e, t) {
                ...
                return new fetch.Promise(function (r, n) {
                    ...
                    f.on('response', function (e) {
                        ...
                        if (
                            i == 'br' &&
                            typeof a.createBrotliDecompress === 'function'
                        ) {
